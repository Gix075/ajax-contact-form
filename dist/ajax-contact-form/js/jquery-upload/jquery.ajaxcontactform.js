...
;(function ( $, window, document, undefined ) {
	...
	"use strict";
		...
		var pluginName = "ajaxContactForm",
            defaults = {
            propertyName: "value"
		};
		...
		$.extend(Plugin.prototype, {
            ...
            formValidation: function (text) {
                    // some logic
                var validated = false,
                    form = $(this.element),
                    inputs = form.find('input.validate').not('input[type="radio"]').not('input[type="checkbox"]'),
                ...
                /* INPUTS VALIDATION */
                /* This checks only if input element is empty or not */
                /* *************************************************** */
